          ...
          >
            <div className="flex items-start justify-between gap-3 mb-2">
              <div>
                ...
                <span className="text-xs text-amber-700 font-medium">{h.type}</span>
              </div>
              {h.link && (
                <a
                  href={h.link}
                  ...
                  className="text-stone-300 hover:text-amber-600 transition-colors mt-0.5 shrink-0"
            ...
            <p className="text-xs text-stone-600 leading-relaxed">{h.description}</p>
          </div>
        ))}
      </div>
    </section>
