      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
        <div>
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-stone-900 leading-tight">
            Everything You Need,
            <br />
            <em className="italic text-stone-500">Nothing You Don't</em>
          </h2>
        </div>
        <Link
          href="/amenities"
          className="inline-flex items-center gap-2 text-sm font-medium text-amber-600 hover:text-amber-700 transition-colors group shrink-0"
        >
          See All Amenities
